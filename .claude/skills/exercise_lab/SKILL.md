...
argument-hint: <step: scan|ideas|generate|1|2|3> [grade] [course] [count stars difficulty]
---
...
- Step selector: `$1` — one of `scan`/`1`, `ideas`/`2`, `generate`/`3`.
...
generate) rather than guessing. If grade/course are missing but the step needs
