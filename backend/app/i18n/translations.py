...
TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "user.reset_pin": {"el": "Reset PIN", "en": "Reset PIN"},
    ...
    # Settings modal
    "settings.avatar_section": {"el": "Αλλαγή Avatar", "en": "Change Avatar"},
    ...
    "chore.scope": {"el": "Εμβέλεια", "en": "Scope"},
    ...
    "btn.reset_pin": {"el": "Reset PIN", "en": "Reset PIN"},
