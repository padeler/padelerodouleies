...
TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "pin_reset.success": {"el": "PIN ενημερώθηκε!", "en": "PIN updated!"},
    ...
    "settings.avatar_saved": {"el": "Avatar ενημερώθηκε!", "en": "Avatar updated!"},
    ...
    "history.action_label_declined": {"el": "Άρνηση δουλειάς", "en": "Declined chore"},
    ...
    "btn.decline": {"el": "Άρνηση", "en": "Decline"},
    "btn.mark_fulfilled": {"el": "Έγινε", "en": "Mark Fulfilled"},
